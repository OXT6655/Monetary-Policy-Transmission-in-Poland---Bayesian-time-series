...
def run_gibbs(Y_dep, X, B0, Omega0_inv, S0, nu0,
    ...
    Full conditional Sigma | B, Y:
      ...
      nu_n = nu0 + T + k
    Under the NIW prior B|Sigma ~ MN(B0, Omega0, Sigma), Sigma ~ IW(S0, nu0),
    the matrix-normal prior contributes k pseudo-observations to the
    Inverse-Wishart degrees of freedom in the Sigma | B, Y conditional.
    """
    T, n   = Y_dep.shape
    k      = X.shape[1]
